...
export const categories = [
  {
    ...
    subgenres: [
      ...
      },
      {
        ...
        bookIds: ["quarantine","tau-zero","the-inverted-world","white-light","moving-mars","rendezvous-with-rama"]
      },
      {
        id: "biological",
        title: "Biological",
        ...
        bookIds: ["blood-music","the-andromeda-strain"]
      }
    ]
  },
  {
    ...
    subgenres: [
      ...
      },
      {
        ...
        detail: "19世紀ヴィクトリア朝や産業革命期を背景に、蒸気機関が主要動力源として極端に発達した架空の世界を描くサブジャンルである。飛行船、機械式計算機、蒸気動力の自動人形といった、当時の人々が想像しえたであろう「未来」が具現化されている。ゴーグル、シルクハット、歯車や真鍮製の装飾といったネオヴィクトリアンの美学も特徴적だ。狂気の科学者や冒険家が登場し、未知の領域への探検や新たな発明に挑む物語が多い。ファンタジーやホラーといった他ジャンルとの融合も頻繁に見られる。",
      ...
      },
      {
        ...
        bookIds: ["pump-six-and-other-stories","the-windup-girl","the-ophiuchi-hotline","proteus-unbound","sisyphean","adobado"]
      },
      {
        id: "solarpunk",
        title: "Solarpunk",
      ...
      },
      {
        ...
        title: "Hopepunk",
        nameJP: "ホープパンク",
        description: "「親切」と「希望」による、ニヒリズムへの反逆",
        detail: "「Grimdark（グリムダーク）」のような冷酷で悲観的な物語へのアンチテーゼとして、2017年頃に提唱されたサブジャンル。 punk（反逆）の精神を「希望を持つこと」「他者に親切であること」「粘り強く生きること」に見出し、どんなに過酷な状況下でも人間性や善性を失わない人々の連帯を描く。決して能天気な楽観主義（ハッピーエンドの保証）ではなく、困難を認めた上で、それでもなお「より良い世界」を信じて行動し続けることの強さを強調する。ポスト・ディストピア的な世界観や、マイノリティへの共感的視点、日常の小さな営みを肯定する物語が多く見られる。",
  ...
  },
  {
    ...
    subgenres: [
      ...
      },
      {
        ...
        bookIds: ["on-the-beach","the-road","hothouse","a-canticle-for-leibowitz"]
      },
      {
        id: "metaphysical",
        title: "Metaphysical SF",
        nameJP: "形而上SF",
        description: "存在、意識、現実の本質を問う哲学的SF",
        detail: "物理的な現象よりも、存在の本質、意識の起源、現実と虚構の境界といった形而上学的な問いを中心に据えるサブジャンルである。「我々は何者か」「現実は何か」「意識とは何か」といった哲学的テーマを、SF的な設定を通じて探求する。P.K.ディックやスタニスワフ・レムの作品に代表される、思弁的で内省的な物語が特徴。表層的な科学技術よりも、認識論や存在論への深い問いかけを重視する。",
    ...
    subgenres: [
      {
        ...
        bookIds: ["i-robot","the-caves-of-steel","do-androids-dream-of-electric-sheep","the-moon-is-a-harsh-mistress","the-murderbot-diaries","we-are-legion-we-are-bob"]
      },
      {
        id: "spaceopera",
        title: "Space Opera",
      ...
      },
      {
        ...
        bookIds: ["the-stars-my-destination","the-garments-of-caean","empire-of-the-atom"]
      },
      {
        id: "military",
        title: "Military SF",
        ...
        bookIds: ["starship-troopers","the-forever-war","old-mans-war","genocidal-organ","sentou-yousei-yukikaze"]
      },
      {
        id: "marine",
        title: "Marine SF",
        ...
        bookIds: ["twenty-thousand-leagues-under-the-sea","dolphin-island","starfish","the-godwhale","karyu-no-miya","dai-yon-kan-hyouki-inter-ice-age-4"]
      },
      {
        id: "botanical",
        title: "Botanical SF",
        nameJP: "植物SF",
        description: "知性を持つ植物と変容する生態系",
        detail: "植物が物語の核心的な要素となるサブジャンルである。知性や意識を持つ植物生命体との接触、旺盛な生命力によって文明が侵食されるポスト・アポカリプス的変容、あるいは植物細胞を演算や電力供給に利用する架空の科学技術などが描かれる。人間中心主義を廃し、植物の特異な生態系や生命循環の論理を通じて、地球環境の変容や生命のあり方そのものを問い直す思考実験としての側面を持つ。",
      ...
      },
      {
        ...
        bookIds: ["lord-of-light","the-shadow-of-the-torturer","scanners-live-in-vain","jougen-no-tsuki-wo-taberu-shishi"]
      },
      {
        id: "timetravel",
        title: "Time Travel",
        ...
        bookIds: ["the-time-machine","doomsday-book","the-door-into-summer","thrice-upon-a-time","the-time-ships","slaughterhouse-five","minus-zero","hateshinaki-nagare-no-hate-ni"]
      },
      {
        id: "sfmystery",
        ...
        bookIds: ["inherit-the-stars","the-caves-of-steel","needle","the-city-the-city","the-terminal-experiment"]
      },
      {
        id: "newwave",
        title: "The New Wave",
        ...
        bookIds: ["the-crystal-world","non-stop","the-beast-that-shouted-love-at-the-heart-of-the-world","babel-17"]
      },
      {
        id: "slipstream",
        title: "Slipstream",
      ...
      },
      {
        ...
        bookIds: ["the-left-hand-of-darkness","ancillary-justice","the-book-of-the-river"]
      },
      {
        id: "humor",
        ...
        bookIds: ["the-hitchhikers-guide-to-the-galaxy","the-androids-dream","the-sirens-of-titan","ningen-sokkuri","the-hole-in-the-corner"]
      },
      {
        id: "firstcontact",
        title: "First Contact",
        ...
        bookIds: ["the-only-neat-thing-to-do","the-three-body-problem","project-hail-mary","story-of-your-life","contact","the-great-silence"]
      },
      {
        id: "uplift",
        title: "Uplift",
        nameJP: "知性化",
        description: "動物への知性の付与",
        detail: "人間や先進的な異星種族が、遺伝子操作や教育を通じて、本来は知性を持たない動物（チンパンジーやイルカなど）に人間と同等の知性を与える「知性化（Uplift）」をテーマとする。知性を獲得した種族のアイデンティティの葛藤、主種族との主従関係、そして宇宙規模の進化の連鎖を描く。デイヴィッド・ブリンの諸作がこのジャンルの代表であり、種の多様性と倫理性について深く問いかける。",
      ...
      },
      {
        ...
        title: "Post-human",
        nameJP: "ポストヒューマン",
        description: "人類の次なる進化と変容",
        detail: "テクノロジーや進化の果てに、現在の人類の定義を超越した存在「ポストヒューマン」へと至る過程や、その後の社会を描くサブジャンルである。ナノテクノロジーによる身体変容、意識のデジタル化（アップロード）、あるいは超越的な知性への進化といったテーマが扱われる。アーサー・C・クラーク『幼年期の終わり』に見られる精神的進化から、グレッグ・ベアのバイオ技術による変容まで、そのアプローチは多岐にわたる。「人間とは何か」という定義そのものを揺さぶる、SFの究極的なテーマの一つである。",
        bookIds: ["childhoods-end","blood-music","beggars-in-spain","hardfought-tangents"]
      },
      {
        id: "religion",
        title: "Religion / Mythology",
        nameJP: "宗教 / 神話",
        description: "神、超越者、信仰と科学の相克",
        detail: "宗教的なテーマや神話をSF的ガジェット、あるいは極限的な思考実験として扱うサブジャンルである。遥か未来の神格化した人類、異星の宗教体系と地球の信仰との衝突、あるいは科学技術が神の領域に達した世界の様子を描く。超越的な存在（「シ」や「オーバーマインド」など）との邂逅を通じて、宇宙の創生や人類の存在意義を根源的に問い直す。神話を高度なテクノロジーの描写として再解釈する「サイエンス・ファンタジー」との親和性も高い。",
        bookIds: ["lord-of-light","ten-billion-days-and-one-hundred-billion-nights","cats-cradle","a-rose-for-ecclesiastes","dune","jougen-no-tsuki-wo-taberu-shishi"]
      },
      {
        id: "generationship",
        title: "Generation Ship",
        nameJP: "世代宇宙船",
        description: "数世代に渡る長期宇宙航行と忘却された使命",
        detail: "恒星間航行には数百年から数千年を要するため、複数世代に渡って航行を続ける「世代宇宙船」を舞台とするサブジャンルである。当初の使命や目的地を忘れ、船内で独自の社会・宗教・文化が発展する。閉鎖環境での社会変容、知識の伝承と喪失、外の宇宙という概念すら消失した世界で、真実を知った者が目にする驚愕。目的の再発見と、世代を超えた使命の継承が描かれる。",
      ...
      },
      {
        ...
        title: "Megastructure",
        nameJP: "巨大構造物",
        description: "リングワールド、ダイソン球など惑星規模を超える人工物",
        detail: "リングワールド、ダイソン球、軌道リングなど、惑星や恒星を取り囲む規模の巨大人工構造物を扱うサブジャンルである。しばしば「Big Dumb Object（巨大で無口な物体）」と呼ばれ、その起源、目的、建造者は謎に包まれている。探査隊が構造物の内部を調査し、失われた文明の痕跡や驚異的な工学技術を発見する過程が描かれる。人類の想像を超えるスケール感と、高度文明の遺産が放つセンス・オブ・ワンダーが特徴。",
      ...
      },
      {
        ...
        title: "Multiverse",
        nameJP: "多元宇宙",
        description: "並行世界、パラレルワールド、量子的分岐",
        detail: "無数の並行宇宙が同時に存在するという「多元宇宙」の概念を扱うサブジャンルである。量子力学の多世界解釈に基づき、選択の分岐ごとに新しい宇宙が生まれるとする作品や、異なる歴史を辿った並行世界間の移動・接触を描く作品が含まれる。タイムトラベルとは異なり、時間軸ではなく並行する世界間の移動が焦点となる。「もしも」の可能性が現実として存在する世界観。",
      ...
      },
      {
        ...
        title: "Mutants",
        nameJP: "ミュータント",
        description: "突然変異による超能力と差別",
        detail: "放射線、化学物質、宇宙線などによる突然変異で超能力や特異な能力を獲得した「ミュータント」を描くサブジャンルである。ポストヒューマンが意図的な技術改造であるのに対し、ミュータントは偶発的な進化の産物として描かれる。差別、迫害、種としてのアイデンティティ危機、進化の次段階としての可能性といったテーマが中心となる。通常の人類との対立と共存、新人類としての目覚めが描かれる。",
      ...
      },
      {
        ...
        description: "仮想空間、シミュレーション仮説、意識のデジタル化",
        detail: "仮想現実技術、現実世界がシミュレーションである可能性（シミュレーション仮説）、意識のデジタル化とアップロードを扱うサブジャンルである。サイバーパンクの電脳空間（ネットワーク上の情報空間）とは異なり、完全に構築された仮想世界や、物理法則すら異なる人工環境が舞台となる。現実と虚構の境界、デジタル不死、仮想の中の倫理、そして「本物」の意味が問われる。",
